...
| :--- | :--- | :--- | :--- |
| `/api/subscribe` | **POST** | `{ "chatId": "string", "city": "string", "time": "string (HH:MM)", "imageType": "string (Bhargava/Drik/Combined)" }` | `200 OK` (User is saved to database) |
| `/api/status` | **GET** | `?chatId=string` | `{ "isSubscribed": boolean, "city": "string", "time": "string", "imageType": "string" }` |
